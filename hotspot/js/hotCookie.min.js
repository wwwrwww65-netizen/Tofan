...
function remember() {
    ...
    var e = document.login.querySelector("#speed").value;
    null != a && "" !== a.value && (a = a.value, "" !== c && (c = c.value), !0 !== b && (b = b.checked), b && setLoginCardCookie(a, c, e))
}
...
function setLoginCardCookie(a, b, e) {
    ...
    if (a) {
        ...
        document.cookie = "speed=" + e + ";expires=" + c;
    }
}

function getLoginCardCookie() {
    var a = document.cookie.split(";"),
        b = { username: "", password: "", speed: "" };
...
function cookieLogin() {
    if (isEnable()) {
        ...
        console.log(a);
        if ("" !== a.username) return console.log("loginCard"), "" === a.password ? getRequest("/login?username=" + a.username + "&var=callBack") : getRequest("/login?username=" + a.username + "&password=" + a.password + "&var=callBack")
    }
}

function clearCookies() { for (var a = $jscomp.makeIterator(["username", "password", "speed"]), b = a.next(); !b.done; b = a.next()) document.cookie = b.value + "=;expires=Thu, 01 Jan 1970 00:00:00 GMT"; }
